...
* supplies the three following APIs: getNumberTraceStreams(), getTraceStreams(), readFloatTrace(buffer, idx).
*
...
* stuff to a backend specific subclass of AbstractTicker. The below Tracer is such a subclass.
*
* Functionality:
*
